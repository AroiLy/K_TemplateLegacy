...
local open = false
local id = RageUI.CreateMenu("Identitée", " ")
id.Closable = false;
id.Closed = function()
    open = false
end
            ...
            Citizen.CreateThread(function()
                while open do
                    RageUI.IsVisible(id, function()
                        ...
                        RageUI.Button("» Prénom", nil, {RightLabel = Prenom}, Prenom2 , {
                            onSelected = function()
                        ...
                        RageUI.Button('» Taille', nil, {RightLabel = Taille}, Taille2, {
                            onSelected = function()
                                Taille = KeyboardInput("Entrez votre taille. (140-200cm)", "", 3)
