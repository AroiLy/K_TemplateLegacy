...
AddEventHandler('esx_status:loaded', function(status)
	...
	TriggerEvent('esx_status:registerStatus', 'hunger', 1000000, '#05973F',
		function(status)
			return true
		end,
		function(status)
	...
	TriggerEvent('esx_status:registerStatus', 'thirst', 1000000, '#0CC0F1',
		function(status)
			return true
		end,
		function(status)
...
-- Fabricant Alcool
RegisterNetEvent('esx_basicneeds:onDrinkbouteillepr')
AddEventHandler('esx_basicneeds:onDrinkbouteillepr', function(prop_name)
	if not IsAnimated then
		prop_name = prop_name or 'prop_rum_bottle'
		IsAnimated = true
...
RegisterNetEvent('esx_basicneeds:onDrinkbouteilleps')
AddEventHandler('esx_basicneeds:onDrinkbouteilleps', function(prop_name)
	if not IsAnimated then
		prop_name = prop_name or 'prop_rum_bottle'
		IsAnimated = true
...
RegisterNetEvent('esx_basicneeds:onDrinkbouteilleadi')
AddEventHandler('esx_basicneeds:onDrinkbouteilleadi', function(prop_name)
	if not IsAnimated then
		prop_name = prop_name or 'prop_rum_bottle'
		IsAnimated = true
